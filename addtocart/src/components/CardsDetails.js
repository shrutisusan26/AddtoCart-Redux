            ...
            <Table>
              <tr>
                <td> 
                  ...
                  <p> <strong> Order Review </strong> Order placed from here recently </p>
                  <p> <strong> Remove </strong> <span><i className='fa fa-trash' style={{color: "red", fontSize:"20", cursor:"pointer"}}></i></span> </p>
                  </td>
              </tr>
            </Table>
          </div>
